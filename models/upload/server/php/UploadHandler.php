...
class UploadHandler
{
    ...
    protected function initialize() {
        ...
        $this->options['row_id'] = 1;
        $this->options['upload_dir'] = dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/'.$this->options['row_id'].'/';
        $this->options['upload_url'] = dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/'.$this->options['row_id'].'/';
    }
